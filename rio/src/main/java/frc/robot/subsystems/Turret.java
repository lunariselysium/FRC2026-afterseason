...
public class Turret extends SubsystemBase {
    ...
    public void updateControlAndTelemetry(boolean publishTelemetry) {
        ...
        SmartDashboard.putNumber(
            "Turret/HeadingThroughBoreRawRotations",
            heading.getRawThroughBoreEncoderRotations()
        );
        SmartDashboard.putNumber(
            "Turret/HeadingThroughBoreRawDegrees",
            heading.getRawThroughBoreEncoderDegrees()
        );
        ...
        SmartDashboard.putNumber(
            "Turret/HeadingEncoderMotorGuidanceErrorDegrees",
            heading.getEncoderMotorGuidanceErrorDegrees()
        );
        SmartDashboard.putBoolean(
            "Turret/HeadingUsedMotorEncoderGuidance",
            heading.didUseMotorEncoderGuidance()
        );
        SmartDashboard.putNumber(
            "Turret/HeadingMotorEncoderGuidanceCorrectionCount",
            heading.getMotorEncoderGuidanceCorrectionCount()
        );
